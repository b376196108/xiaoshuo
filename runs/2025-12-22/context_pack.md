# Context Pack — 2025-12-22

- generated_at_utc: 2025-12-20T11:10:41Z
- max_chars: 80000
  ...
  "open_loops": [
    {
      ...
      "note": "ch002 推进证据：以两日劳力与半担柴换回执和粗粮，短期口粮路径落实",
      "owner": "lin_cen",
    ...
    },
    {
      ...
      "note": "ch002 推进证据：当众亮回执压住流言，但她转而盯点卯迟到",
      "owner": "xu_wenshu",
...
## Recent Chapter Summary (-1) — ch002.md
...
## Recent Chapter Summary (-2) — ch001.md
...
## 主线现状
- 主线事实：林岑穿越到旱荒年，林家粮缸见底，赈粮名册与点卯绑定。ch001夜里差役上门点名，ch002清晨他挤进队伍，到村委用两日劳力与半担柴换到回执与少量粗粮，短期口粮暂稳但代价沉重。点卯时间又被提前到鸡鸣前，名额争夺更紧。
- 当前目标：保住点卯与赈粮资格，稳住短期口粮与柴火消耗，压住邻居流言与名声风险，同时安排劳力与家中守门。
- 情绪走向：惊惧饥寒→忍让求稳→短暂踏实→点卯提前再度绷紧。

## 关键人物关系
- 林岑与家人：陈淑英持家谨慎、担忧口粮；林国柱想出面点卯但体力不稳；杜桂兰守旧但被结果说服。林岑成为决策核心，既要安抚又要分配行动。
- 毒舌邻居许文淑：当众挖苦并威胁“昨夜点火”流言，试图影响名册口风；林岑以回执暂时压住，但她转而盯点卯是否迟到。
- 里正叶守正与差役何开军：掌握名册与规则口径，点卯与赈粮捆绑；回执与劳力债把林岑绑进规则之内。

## 已发生关键事件（按时间顺序）
- 清点余粮见底，林岑用定量分配、浸泡淘洗与闷煮省柴勉强顶一顿。
- 巷道口许文淑当众挖苦、逼抬水罐并放话“今晚点名”，林岑忍让换信息。
...
## 资源与代价细节
- 粗粮与回执来自劳力债与柴火交换，短期口粮有了，但成本锁死。
- 省柴闷煮有效，却增加耗时并拉长灶烟，暴露风险上升。
- 点卯提前，时间与体力压力进一步压缩，迟到即失赈粮资格。
- 回执成了护身符，也成了束缚，必须时刻护住。

## 未解伏笔清单
- loop_food_shortage（progressed，ch001-ch010）：短期口粮靠劳力与柴火换取，仍无稳定来源。
- loop_toxic_neighbor（active，ch001-ch012）：流言风险仍在，许文淑转而盯点卯迟到。
