# Context Pack — 2025-12-23

- generated_at_utc: 2025-12-21T00:28:46Z
- max_chars: 80000
...
target_words: 3200
chapter_goals:
- 承接上章钩子：open_loops_touched: {id: loop_food_shortage, how_it_moved: 以...
- 推进 loop_food_shortage：本章明确短期口粮来源或可执行的换粮路径
- 推进 loop_toxic_neighbor：本章争取里正/村权态度或锁定流言扩散证据
- 种田爽点落地：省柴/省粮流程当天见效，保证当晚更顶饱。
  ...
  "open_loops": [
    {
      ...
      "note": "ch003 推进证据：为保点卯口径再加半日劳力与一捆柴，短期口粮路径更明确但代价上升",
      "owner": "lin_cen",
    ...
    },
    {
      ...
      "note": "ch003 推进证据：许文淑巷口拖延并拉扯回执，回执后来失落，名额风险被放大",
      "owner": "xu_wenshu",
...
## Recent Chapter Summary (-1) — ch003.md
...
## Recent Chapter Summary (-2) — ch002.md
